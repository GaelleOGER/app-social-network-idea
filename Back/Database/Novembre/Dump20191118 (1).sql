...
CREATE TABLE `profil` (
  ...
  `nom` varchar(200) CHARACTER SET utf8 COLLATE utf8_icelandic_ci DEFAULT NULL,
  `prenom` varchar(200) CHARACTER SET utf8 COLLATE utf8_icelandic_ci DEFAULT NULL,
...
-- Dump completed on 2019-11-18  9:31:21
